...
class RegistriesTest < ApplicationSystemTestCase
  ...
  test "creating a Registry" do
    ...
    fill_in "Educationlevel", with: @registry.educationLevel
    fill_in "Latitude", with: @registry.latitude
    fill_in "Longitude", with: @registry.longitude
    fill_in "Name", with: @registry.name
    fill_in "Users", with: @registry.users_id
