...
class RegistriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registry" do
    assert_difference('Registry.count') do
      post registries_url, params: { registry: { educationLevel: @registry.educationLevel, latitude: @registry.latitude, longitude: @registry.longitude, name: @registry.name, users_id: @registry.users_id } }
    end
  ...
  test "should update registry" do
    patch registry_url(@registry), params: { registry: { educationLevel: @registry.educationLevel, latitude: @registry.latitude, longitude: @registry.longitude, name: @registry.name, users_id: @registry.users_id } }
